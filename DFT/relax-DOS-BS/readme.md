...
4. Create **KPOINTS** file
   ...
   - **OPTIONAL**: The script [**kpoints.py**](https://github.com/JosephPVera/DFT-calculations/blob/main/scripts/kpoints.py) create the **KPOINTS** file using the previous steps.
5. Run your work
