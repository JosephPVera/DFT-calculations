...
#################################################################################################     
                                         Relaxation
#################################################################################################
1. Create INCAR_HSE06_relax file, include the tags for hybrid calculations
2. Introduce POSCAR and jobfile
3. Create KPOINTS using command "makekpoints"
4. Create POTCAR using comand "makepot . Pt", change the element according to your material
5. Run your work with command "sub"
6. Check your outcomes
...
2. Use the CONTCAR file from Relaxation_HSE06 section and change the name to POSCAR
3. Copy KPOINTS, POTCAR, jobfile from Relaxation_HSE06 section
3. Run your work
