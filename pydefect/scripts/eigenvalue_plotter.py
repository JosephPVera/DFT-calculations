...
#                                    fontsize=self._mpl_defaults.tick_label_size)
    ...
    def _add_band_edges(self):
        for ax in self.axs:
            ...
            ax.axhspan(self._supercell_vbm, self._supercell_vbm - 1.5, color='lightblue', alpha=0.2) #######################
            ax.axhspan(self._supercell_cbm, self._supercell_cbm + 1.5, color='thistle', alpha=0.2) #########################
    ...
    def _set_y_range(self):
        self.plt.ylim(self._supercell_vbm - 1.3, self._supercell_cbm + 1.5) ##########################
#        if self._y_range:
#            for ax in self.axs:
