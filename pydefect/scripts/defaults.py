...
class Defaults(DefaultsBase):
    def __init__(self):
        ...
        self._defect_energy_colors = \
            ["xkcd:green", "xkcd:red", "xkcd:blue", "xkcd:orange",
             "xkcd:purple", "xkcd:brown", "xkcd:crimson","xkcd:gold",
             "xkcd:magenta", "xkcd:darkblue", "xkcd:navy",  "xkcd:olive", "xkcd:black", "xkcd:indigo"]
